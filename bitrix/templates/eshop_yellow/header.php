...
<div class="wrap">
	<div class="header">
		...
		<div class="vcard header-brandzone<?if ($wizTemplateId == "eshop_horizontal") echo " hnav"?>"  itemscope itemtype = "http://schema.org/LocalBusiness">
			<div class="contactsdata">
				<a href="<?=SITE_DIR?>about/contacts/"><span class="tel" itemprop = "telephone"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
	...
	"ACTIVE_COMPONENT" => "N"
				...
				<span class="workhours"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
