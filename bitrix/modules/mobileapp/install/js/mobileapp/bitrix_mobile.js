 ...
 * @returns {*}
 */
BitrixMobile.prototype.showDocumentsCache = function (params)
{
...
BitrixMobile.prototype.showButtonPanel = function (params)
{
 ...
 * @returns {*}
 */
BitrixMobile.prototype.hideButtonPanel = function (params)
{
 ...
 * @returns {*}
 */
BitrixMobile.prototype.showSelectPicker = function (params)
{
 ...
 * @returns {*}
 */
BitrixMobile.prototype.hideSelectPicker = function (params)
{
 ...
 * @returns {*}
 */
BitrixMobile.prototype.updateButtonBadge = function (params)
{
 ...
 * @param params
 */
BitrixMobile.prototype.openTable = function (params)
{
 ...
 * @constructor
 */
MobileDatabase = function (params)
{
	this.isInit = true;
	this.tableList = [];
...
MobileDatabase.prototype.init = function (params)
{
...
MobileDatabase.prototype.getQuery = function (params)
{
	...
	switch (params.action)
	{
		case "delete":
		{
			strQuery = "DELETE FROM " + tableName.toUpperCase() + " " + this.getFieldPair(where, "WHERE ");
		...
		case "update":
		{
			strQuery = "UPDATE " + tableName.toUpperCase() + " " + this.getFieldPair(set, "SET ") + " " + this.getFieldPair(where, "WHERE ");
		...
		case "select":
		{
			strQuery = "SELECT " + this.getValueArrayString(select, "*") + " FROM " + tableName.toUpperCase() + " " + this.getFieldPair(where, "WHERE ");
			values = this.getValues([where]);
			break;
		}
		case "insert":
