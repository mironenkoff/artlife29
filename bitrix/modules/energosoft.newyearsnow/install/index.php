...
class energosoft_newyearsnow extends CModule
{
	var $MODULE_ID = "energosoft.newyearsnow";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;

	function energosoft_newyearsnow()
	{        		
	...
	{
		CopyDirFiles(
			$_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/energosoft.newyearsnow/install/components",
			$_SERVER["DOCUMENT_ROOT"]."/bitrix/components/energosoft", true, true);
		CopyDirFiles(
			$_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/energosoft.newyearsnow/install/js",
	...
	function DoUninstall()
	{
		...
		DeleteDirFilesEx("/bitrix/components/energosoft/energosoft.newyearsnow");
	}
}
?>