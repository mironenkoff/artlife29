...
Class pull extends CModule
{
	...
	function InstallDB()
	{
		...
		COption::SetOptionString("pull", "path_to_listener", $pull_default_option["path_to_listener"]);
		COption::SetOptionString("pull", "path_to_listener_secure", $pull_default_option["path_to_listener_secure"]);
		COption::SetOptionString("pull", "path_to_websocket", $pull_default_option["path_to_websocket"]);
		COption::SetOptionString("pull", "path_to_websocket_secure", $pull_default_option["path_to_websocket_secure"]);
		COption::SetOptionString("pull", "path_to_publish", $pull_default_option["path_to_publish"]);
		COption::SetOptionString("pull", "websocket", $pull_default_option["websocket"]);
		COption::SetOptionString("pull", "nginx", $pull_default_option["nginx"]);
		COption::SetOptionString("pull", "push", $pull_default_option["push"]);
