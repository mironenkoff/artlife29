	...
	if ($_POST['PULL_GET_CHANNEL'] == 'Y')
	{
		...
		if (is_array($arChannel))
		{
			...
			echo CUtil::PhpToJsObject(Array(
				...
				'PATH' => ($nginxStatus? (CMain::IsHTTPS()? CPullOptions::GetListenSecureUrl($arChannels): CPullOptions::GetListenUrl($arChannels)): '/bitrix/components/bitrix/pull.request/ajax.php?UPDATE_STATE'),
