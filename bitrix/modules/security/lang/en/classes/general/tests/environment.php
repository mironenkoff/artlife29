...
$MESS["SECURITY_SITE_CHECKER_UPLOAD_TMP"] = "PHP temp directory is available to all system users.";
$MESS["SECURITY_SITE_CHECKER_UPLOAD_TMP_RECOMMENDATION"] = "Configure access permissions correctly or use another directory.";
