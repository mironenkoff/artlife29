...
Class bitrix_eshop extends CModule
{
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/bitrix.eshop/install/step.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/bitrix.eshop/install/unstep.php");
	}
}
?>