...
<script type="text/javascript">
    ...
    BX.loadScript('http://maps.api.2gis.ru/1.0', function() {
...
<script type="text/javascript">
    ...
    function map2gis_createMap_<?=$MAP2GIS_ID?>() {
        ...
        map_2g.setCenter( new DG.GeoPoint(<?=CUtil::JSEscape($arData['LON'])?>,
            <?=CUtil::JSEscape($arData['LAT'])?>), <?=CUtil::JSEscape($arData['SCALE'])?> );
