...
Class sale extends CModule
{
	...
	function InstallDB()
	{
		...
		RegisterModuleDependences("sale", "OnCondSaleActionsControlBuildList", "sale", "CSaleActionCtrlPromoGroup", "GetControlDescr", 400);
		RegisterModuleDependences("sale", "OnCondSaleActionsControlBuildList", "sale", "CSaleActionCtrlGift", "GetControlDescr", 500);
	...
	function UnInstallDB($arParams = array())
	{
		...
		UnRegisterModuleDependences("sale", "OnCondSaleActionsControlBuildList", "sale", "CSaleActionCtrlPromoGroup", "GetControlDescr");
		UnRegisterModuleDependences("sale", "OnCondSaleActionsControlBuildList", "sale", "CSaleActionCtrlGift", "GetControlDescr");
