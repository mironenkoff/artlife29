...
if (CSalePaySystemAction::GetParamValue("SELLER_DIR") || !$blank && CSalePaySystemAction::GetParamValue("SELLER_DIR_SIGN"))
{
	$isDirSign = false;
	...
	$pdf->Write(15, CSalePdf::prepareToPdf('Генеральный директор '));
...
if (CSalePaySystemAction::GetParamValue("SELLER_ACC") || !$blank && CSalePaySystemAction::GetParamValue("SELLER_ACC_SIGN"))
{
	$isAccSign = false;
	...
	if ($isAccSign)
		$pdf->SetY($pdf->GetY() + $signHeight - 15);
	$pdf->Write(15, CSalePdf::prepareToPdf('Главный бухгалтер '));
