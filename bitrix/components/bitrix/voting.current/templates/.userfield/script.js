...
if (top.BVotedUser)
	...
	top.BVotedUser.prototype.__construct = function(params) {
		...
		this.onPullEvent = BX.delegate(function(module_id, command, params){
			if (module_id == "vote" && command == 'voting' && !!params && params["VOTE_ID"] == this.voteId)
			{
	...
	top.BVotedUser.prototype.send = function(){
		if (this.status === "ready")
		{
			...
			BX.ajax({
				...
				onfailure: BX.proxy(function(data){this.status = "ready";}, this)
			});
		}
	}
