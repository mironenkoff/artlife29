...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/site_wc/about/idea/",
            "PATH_IDEA_POST" => "/site_wc/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/site_wc/login/?forgot_password=yes",
            "REGISTER_URL" => "/site_wc/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
